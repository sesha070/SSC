...
{
    if(($_REQUEST['lesson_desc']=="") || ($_REQUEST['lesson_name']=="") || ($_REQUEST['course_id']=="")
    ...
    else
    {
      ...
      $sql="INSERT INTO lesson(lesson_name,course_name,lesson_desc,course_id,lesson_link)
            VALUES ('$lesson_name','$course_name','$lesson_desc','$course_id','$link_folder')";
